...
public class UserController {
    ...
    @Operation(
        ...
        description = "Update current user's account information (name and/or password). Use the accessToken from login/signup as the Authorization header.",
            ...
            content = @Content(
                ...
                examples = @ExampleObject(
                    value = """
                    {
                      ...
                      "data": null,
                      "timestamp": "2025-10-23T15:30:00+11:00"
                    }
                    """
                )
            )
    ...
    public ResponseEntity<?> updateAccount(
            ...
            @RequestBody(
                description = "User update details - only include fields you want to update",
                content = @Content(
                    mediaType = "application/json",
                    examples = @ExampleObject(
    ...
    @Operation(
        ...
        description = "Permanently delete current user's account. Use the accessToken from login/signup as the Authorization header.",
        security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                ...
                examples = @ExampleObject(
                    value = """
                    {
                      ...
                      "data": null,
                      "timestamp": "2025-10-23T15:35:00+11:00"
                    }
                    """
                )
            )
    ...
    @Operation(
        ...
        description = "Retrieve current user's account information. Use the accessToken from login/signup as the Authorization header.",
        security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                ...
                examples = @ExampleObject(
                    value = """
                    {
                      ...
                      "timestamp": "2025-10-23T15:40:00+11:00"
                    }
                    """
                )
            )
