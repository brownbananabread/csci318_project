    ...
    public Map<String, Object> processSummary(String userId) throws ServiceException {
        try {
            ...
            Map<String, Object> response = (Map<String, Object>) restTemplate.exchange(
                PERSONALISE_API_BASE + "/api/v1/summary",
            ...
            throw new ServiceException("Failed to process personalisation request: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
