...
/**
 * Publisher for event-related domain events.
 * Publishes events to Kafka topics for asynchronous processing by other services.
 */
@Component
public class EventEventPublisher {
    ...
    /**
     * Publishes an EventCreatedEvent to Kafka.
     *
     * @param event The event created event to publish
     */
    ...
    /**
     * Publishes a UserRegisteredForEventEvent to Kafka.
     *
    ...
    /**
     * Publishes an EventCapacityReachedEvent to Kafka.
     *
     * @param event The capacity reached event to publish
     */
